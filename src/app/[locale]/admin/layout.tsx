      ...
      <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <nav className="p-4">
          <ul className="space-y-1">
            ...
            <li>
              <Link href="/admin/portfolio" className="flex items-center p-3 rounded-lg hover:bg-blue-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 transition-colors duration-200">
                <span className="mr-3">💼</span>
                Portfolio
              </Link>
            </li>
